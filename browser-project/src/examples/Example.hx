...
class Examples {
	public static var list:Array<Example> = [
		...
		},
		{
			...
			command: state -> ['convert', state.inputFiles[0].name]
				.concat("-scale 50% -virtual-pixel mirror ( +clone -distort SRT 22.5 ) ( +clone -distort SRT 22.5 ) ( +clone -distort SRT 22.5 ) ( +clone -distort SRT 22.5 ) ( +clone -distort SRT 22.5 ) ( +clone -distort SRT 22.5 ) ( +clone -distort SRT 22.5 ) ( +clone -distort SRT 22.5 ) ( +clone -distort SRT 22.5 ) ( +clone -distort SRT 22.5 ) ( +clone -distort SRT 22.5 ) ( +clone -distort SRT 22.5 ) ( +clone -distort SRT 22.5 ) ( +clone -distort SRT 22.5 ) ( +clone -distort SRT 22.5 ) ( +clone -distort SRT 22.5 ) output.gif"
					.split(' '))
		},
		{
			name: 'gif-wave-swirl-gif',
			command: state -> "convert -swirl 123 -wave 14x95 -scale 74% -rotate 15 -background transparent".split(" ")
				.concat([state.inputFiles[0].name, 'foo22.gif']),
